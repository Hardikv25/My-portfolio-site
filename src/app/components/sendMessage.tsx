...
export default function sendmessage() {
    ...
    return (
        <div className='flex py-10 sm:py-14 border-t-2 flex-col md:flex-row justify-between items-center'>
            ...
            <button id="mymail" onClick={openMailbox} className='flex shadow-2xl text-[20px] md:text-3xl text-white bg-gradient-to-r from-cyan-400 to-blue-900 px-6 md:px-10  hover:bg-gradient-to-r hover:from-cyan-300 hover:to-blue-800 py-4 rounded-full mt-5 md:mt-0'>
